"""
Django settings for crownfunding project.
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRETE_KET',
    'django-insecure-2zj28+k8gmtmq=(b7@!+m)h)alurlqyx#riok#pkyiy$x99kob'
    )
...
ALLOWED_HOSTS = ['*'] #any host name, like blah.com
...
ROOT_URLCONF = 'crowndfunding.urls'
...
WSGI_APPLICATION = 'crowndfunding.wsgi.application'
